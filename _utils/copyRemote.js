...
var cmd2 = 'lftp -e "rm studiolite.mcs.html" -u' + process.env["usr1"] + ',' + process.env["acc3"] + ' galaxy.signage.me';
var cmd3 = 'lftp -e "mv redirect.html studiolite.mcs.html" -u' + process.env["usr1"] + ',' + process.env["acc3"] + ' galaxy.signage.me';
ftps.raw(cmd1);
ftps.raw(cmd2);
ftps.raw(cmd3);
ftps.raw('exit');
